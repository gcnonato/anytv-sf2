...
class UpdateConversionStatsTestCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('anytv:update_conversion_stats_test')
            ->setDescription('Updating ConversionStats (test) from Conversions.')
        ;
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $text = 'Updating ConversionStats (test) from Conversions.';
