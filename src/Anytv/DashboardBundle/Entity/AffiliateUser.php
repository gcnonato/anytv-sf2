...
class AffiliateUser implements UserInterface, \Serializable
{
     ...
     * @var string
     *
     * @ORM\Column(name="secret_code", type="string", length=32)
     */
    private $secret_code;
    ...
    public function getFullName($default_company_name = true)
    {
        $full_name = '';
        ...
        return $full_name ? $full_name : ($default_company_name ? $this->getAffiliate()->getCompany() : '');
    }
