...
class ProfileController extends Controller
{
    ...
    public function topReferrersAction(Request $request, $page)
    {
      $repository = $this->getDoctrine()->getRepository('AnytvDashboardBundle:Affiliate');
      $translator = $this->get('translator');
      $session = $this->get('session');
      ...
      return $this->render('AnytvDashboardBundle:Profile:topReferrers.html.twig', array('affiliate'=>$affiliate, 'affiliate_user'=>$affiliate_user, 'affiliates'=>$affiliates, 'total_pages'=>$total_pages, 'page'=>$page, 'offset'=>$offset));
    }
    
    public function topConversionsAction(Request $request, $page)
    {
      $repository = $this->getDoctrine()->getRepository('AnytvDashboardBundle:Affiliate');
      $translator = $this->get('translator');
      $session = $this->get('session');
      ...
      return $this->render('AnytvDashboardBundle:Profile:topConversions.html.twig', array('affiliate'=>$affiliate, 'affiliate_user'=>$affiliate_user, 'affiliates'=>$affiliates, 'total_pages'=>$total_pages, 'page'=>$page, 'offset'=>$offset));
    }
    
    public function topPayoutsAction(Request $request, $page)
    {
      $repository = $this->getDoctrine()->getRepository('AnytvDashboardBundle:Affiliate');
      $translator = $this->get('translator');
      $session = $this->get('session');
      ...
      return $this->render('AnytvDashboardBundle:Profile:topPayouts.html.twig', array('affiliate'=>$affiliate, 'affiliate_user'=>$affiliate_user, 'affiliates'=>$affiliates, 'total_pages'=>$total_pages, 'page'=>$page, 'offset'=>$offset));
    }
}